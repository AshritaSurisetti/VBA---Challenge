...
'Calculate the yearly change, percentage change, total stock volume
...
Next i
'Printing the Greatest % increase, Greatest % decrease and total volume to the appropriate cells
